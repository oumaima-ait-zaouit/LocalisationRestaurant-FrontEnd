...
export default function Ville() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!nom) {
            alert("Le nom de la ville est vide !");
        } else {
            ...
            >
                <div className="card">
                    <div className="card-body">
                        <h5 className="card-title" id="modal-modal-title">Ajouter une ville :</h5>
                        <form>
                            <div className="mb-3">
                                <label htmlFor="user-nom" className="form-label">Nom de la ville :</label>
