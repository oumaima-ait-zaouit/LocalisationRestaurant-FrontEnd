                    ...
                    >
                        <div className="card" >
                            <div className="card-body" >
                                <h5 className="card-title" id="modal-modal-title">Enregistrer Restaurant</h5>
                                <form>
                                    <div className="row mb-3">
                                        <div className="col-md-6"><label htmlFor="restaurant-nom" className="form-label">Nom :</label>
                                    ...
                                    <div className="row mb-3">
                                        ...
                                        <input type="date" className="form-control" id="user-password" value={dateOuverture} onChange={(e) => setdateopen(e.target.value)} />
                                    </div>
                                        <div className="col-md-6">
                                        <label htmlFor="restaurant-dateclose" className="form-label">date close:</label>
                                        <input type="date" className="form-control" id="user-password"   value={dateFermeture}
                                    ...
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            >  <option value="">Selectionner a serie </option>
                                        ...
                                        <div className="col-md-6">
                                            <label htmlFor="restaurant-specialite" className="form-label">Specialite :</label>
                                            <select
                                                className="form-control"
                                                id="specialite id"
                                                value={specialiteid}
