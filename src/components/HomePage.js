...
export default function HomePage(){
    ...
    return (
        <div>
            <>
                <main>
                    <section id="home">
                        ...
                        <div className="mt-5">
                            <Button  label="Reserver" severity="help" href="reservation"raised  className="mx-1"/>
                            <Button  label="Restaurants" severity="warning" raised  className="mx-1"/>
            ...
            <>
                <div className="mt-2">
                    <h2 className="promotion-title"></h2>
