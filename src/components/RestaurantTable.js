...
export default function RestaurantTable() {
    ...
    const [restaurantVille, setRestaurantVille] = useState('');
    ...
    const handleDelete = (id) => {
        const confirmDelete = () => {
            axios.delete(`/api/controller/restaurants/${id}`).then(() => {
                ...
                toast.current.show({severity:'danger', summary: 'Done', detail:'Restaurant été bien supprimé', life: 3000});
            });
        };

        confirmDialog({
            message: 'Est-ce-que vous voulez supprimer ce restaurant ?',
            header: 'Confirmation',
    ...
    const handleOpenModal = (restaurant) => {
        ...
        setRestaurantVille(restaurant.ville.id);
                    ...
                    {currentPageItems.map((restaurant) => (
                        <tr key={restaurant.id}>
                            ...
                            */}
                            ...
                            <td>
                                <Button  label="Modifier" severity="help" raised  className="mx-1"  onClick={() => handleOpenModal(restaurant)}/>
                                <Button label="Supprimer" severity="danger"  className="mx-1" text raised  onClick={() => handleDelete(restaurant.id)}/>
                ...
                <div className="card" >
                    <div className="card-body" >
                        ...
                        <form>
                            ...
                            <div className="col-md-6">
                                    <label htmlFor="restaurant-ville" className="form-label">Ville :</label>
                                    <select
                                        value={restaurantVille}
                                        onChange={(e) => setRestaurantVille(e.target.value)}
                                        style={{
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    <label htmlFor="restaurant-zone" className="form-label">Zone :</label>
                                    <select
                                ...
                                <div className="col-md-6">
                                    ...
                                    >  <option value="">Selectioner une serie </option>
                        ...
                        <div className="d-flex justify-content-center mt-3">
                            <Button  label="Annuler" severity="warning" raised  className="mx-1" onClick={handleCloseModal}/>
                            <Button  label="Enregistrer" severity="success" raised  className="mx-1" sx={{ ml:1 }} onClick={() => handleEditRestaurant(selectedRestaurant.id)}/>
                        </div>
                    </div>
                </div>
            </Modal>
