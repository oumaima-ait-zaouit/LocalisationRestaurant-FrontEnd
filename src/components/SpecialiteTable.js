                    ...
                    {currentPageItems.map((specialite,index)=>(
                        <tr key={index}>
                            ...
                            <td>
                                ...
                                <Button  label="Modifier" severity="help" raised  className="mx-1"   onClick={() => handleOpenModal(specialite)} />


                                <Button label="Supprimer" severity="danger"  className="mx-1" text raised   onClick={() => handleDelete(specialite.id)}/>
